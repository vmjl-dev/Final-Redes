document.addEventListener('DOMContentLoaded', function() {
            ...
            // Animación de rayos en el diagrama RIT
            const rays = document.querySelectorAll('.ray');
            rays.forEach((ray, index) => {
                ray.style.animation = `rayPulse ${2 + index * 0.5}s infinite`;
                ...
                styleSheet.insertRule(rayKeyframes, styleSheet.cssRules.length);
            });
            
            // Efecto de onda en el espectro
            const spectrum = document.querySelector('.spectrum');
            spectrum.style.animation = 'spectrumWave 8s infinite linear';
            
            const spectrumKeyframes = `
            ...
            styleSheet.insertRule(spectrumKeyframes, styleSheet.cssRules.length);
        });
